...
def plot_life_expectancy():
    #This will save the graph in the following directory
    save_dir="Life_Expectancy"
    saved_files=[]

    #The csv is read using pandas and extra spaces is removed in all column headers
    ...
    # Define countries to filter and its assosciated colour
    ...
    #This will loop through all the countries and only filter the csv file for that country
    for country in countries:
        ...
        #using x train and y train, the values for each column are assigned
        x_train = country_data["Year"].values
        y_train = country_data["Period life expectancy at birth"].values

        #This will forecast for the maximum number of years given
        ...
        for degree in range(1, 10):
            ...
            #x forecast is created using a numpy array and arranged
